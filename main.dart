...
import 'firebase_auth_screens.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AuthWrapper(), // Use the wrapper instead of direct check
    );
  }
}

// SIMPLE AUTH WRAPPER - FIXED
...
// ALL YOUR CAMERA, UPLOAD, SETTINGS CODE STAYS UNCHANGED
// ONLY THE AUTH PART IS REPLACED
// ===============================================
    ...
    child: Container(
      ...
      child: Row(
        children: const [
          ...
          SizedBox(width: 4),
          Icon(Icons.person, color: Color(0xFF60A5FA), size: 14),
        ],
      ),
    ),
  ),
...
detectedColorName = _getColorName(r, g, b);
detectedHex = '#${r.toRadixString(16).padLeft(2, '0').toUpperCase()}'
...
lastTapPosition = position;
  ...
  try {
    ...
    await firebaseService.saveColorToHistory(
      color: detectedColor!,
      colorName: detectedColorName,
      hex: detectedHex,
      rgb: detectedRgb,
    );
    print('Color saved to Firebase history');
  } catch (e) {
    print('Error saving color to Firebase: $e');
...
setState(() {
detectedColor = Color.fromARGB(255, r, g, b);
detectedColorName = _getShadeName(r, g, b);
detectedHex =
